...
- `N8N_SECURE_COOKIE=false` (http over Tailscale's encrypted transport); telemetry off; metrics on at `/metrics`; timezone Asia/Kolkata; Code-node env/file access hardened; images pinned.
